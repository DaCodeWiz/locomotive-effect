...
export default function Home() {
  ...
  useEffect(() => {
    if (countRef.current && countRef2.current && loaderRef.current) {
      ...
      timeline(sequence1, {
        defaultOptions: { easing: [0.8, 0, 0.2, 1], duration: 2 },
      });
    }
  }, []);
  ...
  useEffect(() => {
    ...
    timeline(sequence2, {
      defaultOptions: { easing: [0.66, 0, 0.2, 1], duration: 1, delay: 5 },
    });
  }, []);
				...
				<div className='hero-container'>
					<div data-scroll data-scroll-speed='-8' className='hero-image'>
						<img
							...
							ref={imageRef}
							src='https://images.unsplash.com/photo-1454789415558-bdda08f4eabb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1179&q=80'
						/>
					</div>
					<div data-scroll data-scroll-speed='-5' className='hero-title'>
						<h1 ref={titleRef}>taking flight</h1>
					</div>
				</div>
				...
				<div className='intro-container' data-scroll data-scroll-speed='0'>
					<p>
						<a
							...
							>
							I just wanted to try out this effect inspired by Nicu Barbaros and
							Awwwards. Feel free to clone it from my github by click on this
							text.
						</a>
						<br /> <br />
						<a
