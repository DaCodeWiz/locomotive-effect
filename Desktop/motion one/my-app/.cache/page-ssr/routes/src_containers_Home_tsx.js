...
function animateStyle(element, key, keyframesDefinition, options = {}) {
    ...
    return () => {
        ...
        if (canAnimateNatively) {
             ...
             */
            const needsToReadInitialKeyframe = !_utils_feature_detection_es_js__WEBPACK_IMPORTED_MODULE_2__.supports.partialKeyframes() && keyframes.length === 1;
        ...
        else if (valueIsTransform && keyframes.every(_motionone_utils__WEBPACK_IMPORTED_MODULE_6__.isNumber)) {
            /**
...
/* harmony import */ var _motionone_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @motionone/utils */ "./node_modules/@motionone/utils/dist/defaults.es.js");
/* harmony import */ var _motionone_utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @motionone/utils */ "./node_modules/@motionone/utils/dist/is.es.js");
/* harmony import */ var _motionone_utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @motionone/utils */ "./node_modules/@motionone/utils/dist/offset.es.js");
/* harmony import */ var _motionone_utils__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @motionone/utils */ "./node_modules/@motionone/utils/dist/progress.es.js");
/* harmony import */ var _utils_stagger_es_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/stagger.es.js */ "./node_modules/@motionone/dom/dist/utils/stagger.es.js");
...
/* harmony import */ var _animate_utils_resolve_elements_es_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../animate/utils/resolve-elements.es.js */ "./node_modules/@motionone/dom/dist/animate/utils/resolve-elements.es.js");
/* harmony import */ var _animate_utils_transforms_es_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../animate/utils/transforms.es.js */ "./node_modules/@motionone/dom/dist/animate/utils/transforms.es.js");
/* harmony import */ var _utils_calc_time_es_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/calc-time.es.js */ "./node_modules/@motionone/dom/dist/timeline/utils/calc-time.es.js");
/* harmony import */ var _utils_edit_es_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./utils/edit.es.js */ "./node_modules/@motionone/dom/dist/timeline/utils/edit.es.js");
/* harmony import */ var _utils_sort_es_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./utils/sort.es.js */ "./node_modules/@motionone/dom/dist/timeline/utils/sort.es.js");
...
function timeline(definition, options = {}) {
    ...
    const animationFactories = animationDefinitions
        ...
        .filter(Boolean);
    return (0,_animate_utils_controls_es_js__WEBPACK_IMPORTED_MODULE_2__.wrapAnimationWithControls)(animationFactories, 
...
function createAnimationsFromTimeline(definition, _a = {}) {
    ...
    for (let i = 0; i < definition.length; i++) {
        ...
        if (options.at !== undefined) {
            currentTime = (0,_utils_calc_time_es_js__WEBPACK_IMPORTED_MODULE_4__.calcNextTime)(currentTime, options.at, prevTime, timeLabels);
        }
        /**
         ...
         */
        const elements = (0,_animate_utils_resolve_elements_es_js__WEBPACK_IMPORTED_MODULE_5__.resolveElements)(elementDefinition, elementCache);
        ...
        for (let elementIndex = 0; elementIndex < numElements; elementIndex++) {
            ...
            for (const key in keyframes) {
                ...
                let valueKeyframes = (0,_animate_utils_keyframes_es_js__WEBPACK_IMPORTED_MODULE_6__.keyframesList)(keyframes[key]);
                const valueOptions = (0,_animate_utils_options_es_js__WEBPACK_IMPORTED_MODULE_7__.getOptions)(options, key);
                let { duration = defaultOptions.duration || _motionone_utils__WEBPACK_IMPORTED_MODULE_8__.defaults.duration, easing = defaultOptions.easing || _motionone_utils__WEBPACK_IMPORTED_MODULE_8__.defaults.easing, } = valueOptions;
                if ((0,_motionone_utils__WEBPACK_IMPORTED_MODULE_9__.isEasingGenerator)(easing)) {
                    const valueIsTransform = (0,_animate_utils_transforms_es_js__WEBPACK_IMPORTED_MODULE_10__.isTransform)(key);
                ...
                const delay = (0,_utils_stagger_es_js__WEBPACK_IMPORTED_MODULE_11__.resolveOption)(options.delay, elementIndex, numElements) || 0;
                const startTime = currentTime + delay;
                const targetTime = startTime + duration;
                /**
                 *
                 */
                let { offset = (0,_motionone_utils__WEBPACK_IMPORTED_MODULE_12__.defaultOffset)(valueKeyframes.length) } = valueOptions;
                /**
                ...
                remainder > 0 && (0,_motionone_utils__WEBPACK_IMPORTED_MODULE_12__.fillOffset)(offset, remainder);
                /**
                 ...
                 */
                (0,_utils_edit_es_js__WEBPACK_IMPORTED_MODULE_13__.addKeyframes)(valueSequence, valueKeyframes, easing, offset, startTime, targetTime);
    ...
    elementSequences.forEach((valueSequences, element) => {
        for (const key in valueSequences) {
             ...
             */
            valueSequence.sort(_utils_sort_es_js__WEBPACK_IMPORTED_MODULE_14__.compareByTime);
            const keyframes = [];
            const valueOffset = [];
            const valueEasing = [];
            /**
            ...
            for (let i = 0; i < valueSequence.length; i++) {
                ...
                valueOffset.push((0,_motionone_utils__WEBPACK_IMPORTED_MODULE_15__.progress)(0, totalDuration, at));
                valueEasing.push(easing || _motionone_utils__WEBPACK_IMPORTED_MODULE_8__.defaults.easing);
            }
            /**
...
/* harmony import */ var _motionone_animation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @motionone/animation */ "./node_modules/@motionone/animation/dist/utils/easing.es.js");
...
function addKeyframes(sequence, keyframes, easing, offset, startTime, endTime) {
    ...
    for (let i = 0; i < keyframes.length; i++) {
        sequence.push({
            ...
            easing: (0,_motionone_animation__WEBPACK_IMPORTED_MODULE_2__.getEasingForSegment)(easing, i),
        });
    }
}
...
const useLocomotiveScroll = ({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (ref !== null && ref !== void 0 && ref.current) {
      locomotiveScrollRef.current = new (locomotive_scroll__WEBPACK_IMPORTED_MODULE_1___default())({ ...otherProps,
        el: ref.current
      });
    }
